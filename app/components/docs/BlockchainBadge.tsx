...
export default function BlockchainBadge({ name, logo }: BlockchainBadgeProps) {
  return (
    <div className="flex items-center gap-2 px-4 py-2.5 bg-black/80 backdrop-blur-sm hover:bg-black/90 rounded-lg border border-white/[0.15] transition-all hover:border-[#74a180]/30">
