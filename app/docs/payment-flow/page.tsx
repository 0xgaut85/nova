  ...
  return (
    <div className="prose prose-sm max-w-none">
      ...
      <div className="bg-gradient-to-br from-white/80 to-white/40 backdrop-blur-xl rounded-2xl p-6 border border-black/5 shadow-xl mb-8 not-prose">
        <h2 className="text-lg font-light italic text-black mb-2">The x402 Payment Protocol</h2>
      ...
      <h2 className="text-2xl font-light italic text-black mb-4 mt-8">Step-by-Step Flow</h2>

      <div className="space-y-4 mb-8">
        <div className="bg-white/60 backdrop-blur-sm rounded-xl p-6 border border-black/5">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-8 h-8 bg-gradient-to-br from-[#FF7B00] to-[#FF9500] text-white rounded-lg flex items-center justify-center text-xs font-light italic">
              1
            </div>
            <h3 className="text-base font-light italic text-black m-0">Client Initiates Request</h3>
          </div>
...
Accept: application/json`}
        ...
        <div className="bg-white/60 backdrop-blur-sm rounded-xl p-6 border border-black/5">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-base font-light italic text-black m-0">Server Returns 402</h3>
          </div>
          <p className="text-sm text-black/80 mb-3">
  ...
  "network": "base"
        ...
        <div className="bg-white/60 backdrop-blur-sm rounded-xl p-6 border border-black/5">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-base font-light italic text-black m-0">Client Parses Payment Info</h3>
          </div>
          <p className="text-sm text-black/80 mb-3">
        ...
        <div className="bg-white/60 backdrop-blur-sm rounded-xl p-6 border border-black/5">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-base font-light italic text-black m-0">Create Transaction</h3>
          </div>
          <p className="text-sm text-black/80 mb-3">
  ...
  "data": "0x..." // USDC transfer call data
        ...
        <div className="bg-white/60 backdrop-blur-sm rounded-xl p-6 border border-black/5">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-base font-light italic text-black m-0">Sign & Broadcast</h3>
          </div>
        ...
        <div className="bg-white/60 backdrop-blur-sm rounded-xl p-6 border border-black/5">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-base font-light italic text-black m-0">Retry with Proof</h3>
          </div>
          <p className="text-sm text-black/80 mb-3">
...
Accept: application/json`}
        ...
        <div className="bg-white/60 backdrop-blur-sm rounded-xl p-6 border border-black/5">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-base font-light italic text-black m-0">Server Validates Payment</h3>
          </div>
          <p className="text-sm text-black/80 m-0">
        ...
        <div className="bg-white/60 backdrop-blur-sm rounded-xl p-6 border border-black/5">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-base font-light italic text-black m-0">Service Delivered</h3>
          </div>
          <p className="text-sm text-black/80 mb-3">
...

{
  ...
  "timestamp": "2025-01-01T00:00:00Z"
      ...
      <h2 className="text-2xl font-light italic text-black mb-4 mt-8">Payment Verification</h2>

      <div className="bg-white/60 backdrop-blur-sm rounded-xl p-5 border border-black/5 mb-4">
        <h3 className="text-sm font-light italic text-black mb-3">On-Chain Verification</h3>
        <p className="text-sm text-black/80 leading-relaxed">
          The facilitator verifies payments by querying the blockchain directly. It checks:
        </p>
        <ul className="text-sm text-black/80 space-y-1 mt-2 mb-0">
      ...
      <div className="bg-white/60 backdrop-blur-sm rounded-xl p-5 border border-black/5 mb-8">
        <h3 className="text-sm font-light italic text-black mb-3">Facilitator Role</h3>
        <p className="text-sm text-black/80 leading-relaxed">
      ...
      <h2 className="text-2xl font-light italic text-black mb-4 mt-8">Edge Cases</h2>
      ...
      <div className="grid md:grid-cols-2 gap-4 mb-8 not-prose">
        <div className="bg-white/60 backdrop-blur-sm rounded-xl p-5 border border-black/5">
          <h3 className="text-sm font-light italic text-black mb-2">Insufficient Payment</h3>
        ...
        <div className="bg-white/60 backdrop-blur-sm rounded-xl p-5 border border-black/5">
          <h3 className="text-sm font-light italic text-black mb-2">Network Mismatch</h3>
          <p className="text-sm text-black/80">
        ...
        <div className="bg-white/60 backdrop-blur-sm rounded-xl p-5 border border-black/5">
          <h3 className="text-sm font-light italic text-black mb-2">Unconfirmed Transaction</h3>
          <p className="text-sm text-black/80">
        ...
        <div className="bg-white/60 backdrop-blur-sm rounded-xl p-5 border border-black/5">
          <h3 className="text-sm font-light italic text-black mb-2">Replay Attack Prevention</h3>
          <p className="text-sm text-black/80">
      ...
      <div className="bg-gradient-to-r from-[#FF7B00] to-[#FF9500] rounded-2xl p-6 text-white not-prose">
        <h3 className="text-lg font-light italic mb-2">Dive Deeper</h3>
